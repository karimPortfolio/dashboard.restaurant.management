...
export function useResourceIndex(
  ...
  watchEffect(() => {
    ...
    // options.pagination.rowsPerPage = opts.pagination?.rowsPerPage ?? 10;
    // options.pagination.page = opts.pagination?.page ?? 1;
    // options.pagination.from = opts.pagination?.from ?? 0;
    // options.pagination.to = opts.pagination?.to ?? 0;
